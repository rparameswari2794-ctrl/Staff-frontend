// src/pages/manager/ManagerSalary.jsx
...
const ManagerSalary = () => {
    ...
    const fetchMySalaryData = async () => {
        try {
            ...
            console.log('========== DEBUG: Fetching Manager Salary Data ==========');
            console.log('Current manager from Redux:', user);
            ...
            if (!currentEmployee) {
                console.error('❌ No employee found for manager:', user);
    ...
    return (
        <Container style={{ marginTop: '80px' }} fluid>
            <h2 className="mb-4">My Salary (Manager)</h2>
